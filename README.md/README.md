...
- Revenue breakdown by category, country, and channel
- Product performance (top products by revenue & quantity)
- Customer behavior (top customers, purchase frequency, segmentation)
- Time-based analysis (monthly trends, daily orders)
- Returns and payment method analysis
...
- Interactive dashboard with filters (Country, Sales Channel)  
- Business-focused insights with real metrics  
...
2. Use filters (Country, Sales Channel) to explore data  
